...
package body result_parser is 
   ...
   Procedure parse_task_response_time( sys : in System; Processor_name : in Unbounded_String; input : in unbounded_string ; num_echeance: out Integer;  Result:  out Unbounded_String) is
   ...
   --      raise parser_error;
   --   end if;
      Append (Result, "<sum_response_time>"& sum_response_time'Img &"<\sum_response_time>" & ASCII.LF);
      Append (Result, "<sum_laxity>"& sum_laxity'Img &"<\sum_laxity>" & ASCII.LF);
      Append (Result, "<num_echeance>"& num_echeance'Img &"<\num_echeance>" & ASCII.LF);
...
Procedure parse_task_context_switch( sys : in System;Processor_name : in Unbounded_String;  input : in unbounded_string ; Result:  out Unbounded_String) is
      start,finish          : integer;
      task_exist            : integer;
      Nb_tasks              : integer;
...
begin
   ...
   --   if sub_str = To_Unbounded_String("- No d") then
      ...
      -- i.e : context switches, number of preemptions, laxity of tasks
         ...
         Append (Result, "<nb_context_switches>"&Nb_context_switches'img & "<\nb_context_switches>" & ASCII.LF);
...
Procedure parse_task_preemption( sys : in System;Processor_name : in Unbounded_String;  input : in unbounded_string ; 
 ...
 --     if sub_str = To_Unbounded_String("- No d") then
      ...
      -- i.e : context switches, number of preemptions, laxity of tasks
         ...
         Append (Result, "<nb_preemptions>"&Nb_preemptions'img & "<\nb_preemptions>" & ASCII.LF);
