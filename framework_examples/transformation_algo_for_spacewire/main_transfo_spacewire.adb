...
procedure main_transfo_spacewire is
	...
	a_network 				 : spacewire_network_ptr;
...
Begin 
	...
	initialize(sys);
       	...
       	Read_From_Xml_File (sys, dir1, "framework_examples/transformation_algo_for_spacewire/input_Model.xmlv3" );


	a_network:=Spacewire_Network_ptr(search_network(sys.networks, to_unbounded_string("Spacewire_net")));
	...
	compute_spw_source_destination_task_position       ( SourceTask_position_Table 		 => SourceTask_position_Table ,
	...
	generate_links_spw  	  (  A_link_mat           	         => A_link_mat,
				     My_messages	     		 => Sys.messages,
			             SourceTask_position_Table 		 => SourceTask_position_Table ,
				     DestinationTask_position_Table 	 => DestinationTask_position_Table ,
				     SourceTask_rank_table    		 => SourceTask_rank_table,
	...
	-------------------------------------
	--- transforme the input model into the output model (Modèle d'analyse)
	--- selon la méthode SpaceWire Communication Model ...  
	-------------------------------------



	flow_to_task_spw (  My_processors	            => Sys.Processors,
			       My_tasks			    => Sys.Tasks,
			       My_messages	            => Sys.messages, 
	...
	-- the outputfile (Modèle d'analyse) is framework_examples/transformation_algo_for_spacewire/output_Model.xmlv3



        --initialize(Sys1);
       	--Read_From_Xml_File (Sys1, dir1, "framework_examples/transformation_algo_for_spacewire/output_Model.xmlv3" );
	...
	-- afficher les tâches/ les processeurs / les messages ... du système de sortie 
       ...
       --compute_scheduling_of_tasks(200, Sys1,To_Unbounded_String("framework_examples/transformation_algo_for_spw/Scheduling_Result"),true);


end  main_transfo_spacewire;
---
