...
package body generator_spacewire is


     procedure generate_spw  (  Nbr_task_in_processor	    	    : in integer  ; 
  ...
  begin
	...
	for j in 0 .. Y_max loop 
     ...
     Add_Network (My_Networks          => a_system.networks		,
                   Name                => To_Unbounded_String ("Spacewire_net")	,
                   Network_Type        => Mesh          			,
	...
	for j in 1 .. Nbr_task_in_processor loop 
      ...
      Write_To_Xml_File
        (A_System  => a_system,
         File_Name => Suppress_Space (To_Unbounded_String ("framework_examples/transformation_algo_for_spacewire/Input_file/input_Model" & iteration'Img & ".xmlv3")));
