...
procedure feasibility_interval is
   sys                         : system;
   tasks                       : tasks_set;
   project_file_list           : unbounded_string_list;
   project_file_dir_list       : unbounded_string_list;
   feasibility_interval_double : Double;
   validate                    : Boolean := False;

   simulation_interval_txt : Unbounded_String;
   ...
   begin
      Put_Line
        ("feasibility_interval computes the feasiblity interval of  a Cheddar architecture model .");
      New_Line;
      Put_Line
        ("Check Cheddar home page for details :  http://beru.univ-brest.fr/~singhoff/cheddar ");
      New_Line;
      New_Line;
      Put_Line ("Usage : feasibility_interval [switch] ");
...
begin
   copyright ("feasibility_interval");
   ...
   calculate_feasibility_interval
     (sys,
      processor1,
      validate,
      feasibility_interval_double,
      msg);
   Put_Line
     (validate'img &
      "::Interval in [0," &
      feasibility_interval_double'img &
      ")");

end feasibility_interval;
