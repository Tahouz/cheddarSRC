...
--à supprimer
   ...
   procedure usage is
   begin
      Put_Line ("vs computes the optimal frequencies for a task set.");
      New_Line;
      Put_Line
        ("Check Cheddar home page for details :  http://beru.univ-brest.fr/~singhoff/cheddar ");
      New_Line;
      New_Line;
      Put_Line ("Usage : vs [switch] ");
...
begin
   ...
   -- Read he Cheddar XMLv3 file in memory
   systems.read_from_xml_file (sys, project_file_dir_list, input_file_name);

   -- Put on screen the set of task contained by the read XML file
   print_task_set (sys.tasks);


   -- Manipulate chromosome
