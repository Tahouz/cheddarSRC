...
-- Last update : 
--    $Rev: 6221 $
--    $Date: 2026-01-26 02:03:48 +0100 (lun., 26 janv. 2026) $
--    $Author: nam $
------------------------------------------------------------------------------
------------------------------------------------------------------------------
...
package TSN_Scheduling_Simulation_Test is

   function scheduling_simulation_tsn
     (Period 		: in Natural;
      Sys 		: in out System;
...
end TSN_Scheduling_Simulation_Test;
