...
procedure generator_noc is 
  ...
  begin
	...
	Initialize (a_system.Tasks);
	    ...
	    for j in 1 .. N_Tasks loop
	       ...
	       Add_Task(My_Tasks                 => a_system.Tasks,
               A_Task			 	 => a_task,
               Name                      	 => Suppress_Space (To_Unbounded_String ("Task"&j'Img&j'Img)),
      ...
      for i in 1 ..N_messages loop 
      	...
      	Add_Message    (My_Messages        => a_system.messages,
		     	Name               => Suppress_Space (To_Unbounded_String("Message" & i'Img)),
		      	Size               => 12,
		      	Period             => 10,
		      	Deadline           => 10,
		      	Jitter             => 0,
	...
	loop
	    ...
	    A_task1 :=  Search_Task (a_system.Tasks, Suppress_Space (To_Unbounded_String ("Task11"))) ;
            A_task2 :=  Search_Task (a_system.Tasks, Suppress_Space (To_Unbounded_String ("Task"&i'Img&i'Img)));   
      ...
      Write_To_Xml_File
        (A_System  => a_system,
         File_Name => "framework_examples/transformation_algo_for_noc/input_Model.xmlv3");
