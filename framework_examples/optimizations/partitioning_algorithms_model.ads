...
package partitioning_algorithms_model is
...
-- off-line partition scheduling hierarchical scheduler : partitions are activated
-- according to a event table (off line scheduling)
--

   procedure build_tasks_set (my_tasks : in out Tasks_Set);
