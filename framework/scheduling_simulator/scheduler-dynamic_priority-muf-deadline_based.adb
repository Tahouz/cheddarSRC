...
package body scheduler.dynamic_priority.muf.deadline_based is

   procedure initialize (a_scheduler : in out deadline_muf_scheduler) is
   begin
      reset (a_scheduler);
   ...
   is
      ptr : deadline_muf_scheduler_ptr;

   begin

      ptr := new deadline_muf_scheduler;
               ...
               then
                  ...
                  then
                     ...
                     then
                        ...
                        -- Select according to the deadline, criticality and
                        -- priority
                        --
