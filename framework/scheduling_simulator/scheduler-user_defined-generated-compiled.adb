...
package body scheduler.user_defined.generated.compiled is

   procedure initialize
     (a_scheduler : in out compiled_user_defined_scheduler)
   is
   begin
      reset (a_scheduler);
      a_scheduler.parameters.scheduler_type := compiled_user_defined_protocol;
   end initialize;
   ...
   is
      ptr : compiled_user_defined_scheduler_ptr;

   begin

      ptr := new compiled_user_defined_scheduler;
   ...
   begin
      run_start_section
        (generated_user_defined_scheduler (my_scheduler),
         processor_name,
         msg);
