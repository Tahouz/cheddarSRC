...
package scheduler.dynamic_priority.muf.laxity_based is

   type laxity_muf_scheduler is new muf_scheduler with private;
   type laxity_muf_scheduler_ptr is access all laxity_muf_scheduler'class;

   procedure initialize (a_scheduler : in out laxity_muf_scheduler);
...
private
   ...
   type laxity_muf_scheduler is new muf_scheduler with null record;
