...
package scheduler.fixed_priority.aperiodic_server.sporadic is

   type sporadic_aperiodic_server_scheduler is
     new aperiodic_server_scheduler with private;
   type sporadic_aperiodic_server_scheduler_ptr is
     access all sporadic_aperiodic_server_scheduler'class;
...
private
   ...
   type sporadic_aperiodic_server_scheduler is new aperiodic_server_scheduler with
   record
      server_is_idle : Boolean := True;
   end record;
