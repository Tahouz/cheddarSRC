...
package scheduler.hierarchical.cyclic is

   type hierarchical_cyclic_scheduler is
     new hierarchical_scheduler with private;
   type hierarchical_cyclic_scheduler_ptr is
     access all hierarchical_scheduler'class;

   procedure initialize (a_scheduler : in out hierarchical_cyclic_scheduler);
...
private
   ...
   type hierarchical_cyclic_scheduler is new hierarchical_scheduler with record
