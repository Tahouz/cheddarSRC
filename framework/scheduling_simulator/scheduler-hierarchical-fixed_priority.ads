...
package scheduler.hierarchical.fixed_priority is

   type hierarchical_fixed_priority_scheduler is
     new hierarchical_scheduler with private;
   type hierarchical_fixed_priority_scheduler_ptr is
     access all hierarchical_scheduler'class;

   procedure initialize (a_scheduler : in out hierarchical_fixed_priority_scheduler);
...
private
   ...
   type hierarchical_fixed_priority_scheduler is new hierarchical_scheduler with record
