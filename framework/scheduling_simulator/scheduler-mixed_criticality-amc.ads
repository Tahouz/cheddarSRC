...
package scheduler.mixed_criticality.amc is

   type mixed_criticality_amc_scheduler_ptr is
     access all mixed_criticality_scheduler'class;
     
   type mixed_criticality_amc_scheduler is new mixed_criticality_scheduler with
   null record;

  

   procedure initialize (a_scheduler : in out mixed_criticality_amc_scheduler);
