...
package scheduler.mixed_criticality.edf_vd is

   type mixed_criticality_edf_vd_scheduler is
     new mixed_criticality_scheduler with private;
   type mixed_criticality_edf_vd_scheduler_ptr is
...
private
   ...
   type mixed_criticality_edf_vd_scheduler is new mixed_criticality_scheduler with
   record
