...
package scheduler.fixed_priority.aperiodic_server is

   type aperiodic_server_scheduler is
     abstract new fixed_priority_scheduler with private;
   type aperiodic_server_scheduler_ptr is
...
private
   ...
   type aperiodic_server_scheduler is abstract new fixed_priority_scheduler with
   record
      periodic_highest_priority  : Natural     := Natural'first;
      aperiodic_highest_priority : Natural     := Natural'first;
      periodic_elected           : tasks_range := 0;
      aperiodic_elected          : tasks_range := 0;

      current_server_wake_time : Natural;
      current_server_capacity  : Natural;
   end record;
