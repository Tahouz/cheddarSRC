...
package scheduler.dag.highest_level_first_estimated_times is

   type dag_highest_level_first_estimated_times_scheduler is new dag_scheduler with
   null record;
   type dag_highest_level_first_estimated_times_scheduler_ptr is
     access all dag_highest_level_first_estimated_times_scheduler'class;
