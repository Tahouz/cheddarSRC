...
package scheduler.fixed_priority.aperiodic_server.deferrable is

   type deferrable_aperiodic_server_scheduler is
     new aperiodic_server_scheduler with private;
   type deferrable_aperiodic_server_scheduler_ptr is
     access all deferrable_aperiodic_server_scheduler'class;
...
private
   ...
   type deferrable_aperiodic_server_scheduler is new aperiodic_server_scheduler with
   null record;
