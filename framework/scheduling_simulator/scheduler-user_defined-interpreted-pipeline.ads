...
package scheduler.user_defined.interpreted.pipeline is

   type pipeline_user_defined_scheduler is
     new interpreted_user_defined_scheduler with private;
   type pipeline_user_defined_scheduler_ptr is
     access all pipeline_user_defined_scheduler'class;

   procedure initialize (a_scheduler : in out pipeline_user_defined_scheduler);

   function copy
     (a_scheduler : in pipeline_user_defined_scheduler)
      return generic_scheduler_ptr;

   procedure put (my_scheduler : in pipeline_user_defined_scheduler);
...
private
   ...
   type pipeline_user_defined_scheduler is new interpreted_user_defined_scheduler with
   record
