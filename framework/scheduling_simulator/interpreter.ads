...
package Sets_Type_Package is new Tables(Set_Statement_Ptr, Max_Statements, Put, XML_String, XML_Ref_String);
use Sets_Type_Package;
subtype Sets_Range is Sets_Type_Package.table_range;
subtype Sets_Range_Ptr is  Sets_Type_Package.table_range_Ptr;
subtype Sets_Table_Type is Sets_Type_Package.table;
subtype Sets_Table_Type_Ptr is  Sets_Type_Package.table_Ptr;

type Section_Table is Array ( Sections_Type'Range ) of Generic_Statement_Ptr;
