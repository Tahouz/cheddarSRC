...
package scheduler.time_sharing_based_on_wait_time is

   type time_sharing_based_on_wait_time_scheduler is
     new generic_scheduler with private;
   type time_sharing_based_on_wait_time_scheduler_ptr is
     access all time_sharing_based_on_wait_time_scheduler'class;

   type time_sharing_based_on_wait_time_tcb is new tcb with record
      last_time_the_task_was_ready : Natural;
      is_ready                     : Boolean;
   end record;

   type time_sharing_based_on_wait_time_tcb_ptr is
     access all time_sharing_based_on_wait_time_tcb'class;

   procedure initialize (a_tcb : in out time_sharing_based_on_wait_time_tcb);
   ...
   procedure put (my_scheduler : in time_sharing_based_on_wait_time_scheduler);
...
private
   ...
   type time_sharing_based_on_wait_time_scheduler is new generic_scheduler with
   null record;
