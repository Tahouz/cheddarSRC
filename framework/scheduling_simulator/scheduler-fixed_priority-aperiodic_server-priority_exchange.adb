...
package body scheduler.fixed_priority.aperiodic_server.priority_exchange is
   ...
   is
      ptr : priority_exchange_aperiodic_server_scheduler_ptr;

   begin

      ptr := new priority_exchange_aperiodic_server_scheduler;
