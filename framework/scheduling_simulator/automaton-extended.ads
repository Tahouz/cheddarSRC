...
package Automaton.extended is

   transition_not_found : exception;
   state_not_found : exception;
   ...
   function search_initial_state (a_list : in state_lists) return state_ptr;
