...
-- Last update :
--    $Rev: 4962 $
--    $Date: 2024-04-11 20:12:10 +0200 (jeu., 11 avril 2024) $
--    $Author: singhoff $
------------------------------------------------------------------------------
------------------------------------------------------------------------------

package scheduler.mixed_criticality.smc is

   type mixed_criticality_smc_scheduler_ptr is
     access all mixed_criticality_scheduler'class;
     
   type mixed_criticality_smc_scheduler is new mixed_criticality_scheduler with
   null record;

  

   procedure initialize (a_scheduler : in out mixed_criticality_smc_scheduler);
