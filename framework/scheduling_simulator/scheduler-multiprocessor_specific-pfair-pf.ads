...
package scheduler.multiprocessor_specific.pfair.pf is

   type multiprocessor_pfair_pf_scheduler is
     new multiprocessor_pfair_scheduler with private;
   type multiprocessor_pfair_pf_scheduler_ptr is
     access all multiprocessor_pfair_pf_scheduler'class;
...
private
   ...
   type multiprocessor_pfair_pf_scheduler is new multiprocessor_pfair_scheduler with
   null record;
