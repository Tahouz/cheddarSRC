...
package scheduler.mixed_criticality.recurrent_quality_amc is 

      
   type mixed_criticality_recurrent_quality_amc_scheduler is new mixed_criticality_scheduler
   with null record;
   

   type mixed_criticality_recurrent_quality_amc_scheduler_ptr is
     access all mixed_criticality_scheduler'class;

   procedure initialize (a_scheduler : in out mixed_criticality_recurrent_quality_amc_scheduler);
