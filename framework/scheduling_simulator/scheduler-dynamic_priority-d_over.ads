...
package scheduler.dynamic_priority.d_over is

   type d_over_scheduler is new dynamic_priority_scheduler with private;
   type d_over_scheduler_ptr is access all d_over_scheduler'class;

   procedure initialize (a_scheduler : in out d_over_scheduler);
...
private
   ...
   type d_over_scheduler is new dynamic_priority_scheduler with null record;
