...
type Time_Unit_Event_io is record
	...
	energy_battery : Unbounded_String;
	energy_level : Integer;
	slot_duration : Integer;
	slot_message : Unbounded_String;
	from_mode : Integer;
	to_mode : Integer;
end record;
...
type Dependency_io is record
	...
	tdma_communication_dependent_task : Unbounded_String;
	tdma_communication_orientation : Orientation_Dependency_Type;
	tdma_communication_dependency_object : Unbounded_String;
