...
int Va_filter_100449_fun(void* args)
{
  ...
  const struct write_proto_t Va_f_Va_control_50474_Va_f_write =  { NULL, 0, (int []){ true , false }, 2 };
  static int Va_f_Va_control_50474_Va_f_wcell=0;
  static int instance=0;
  
  struct timespec starttime, executiontime, currentime;
  int status;
  
#ifdef CONFIGURE_MONANO_RTEMS48
 #ifdef CONFIGURE_MONANO_TASKS_EXECUTION_TIME
  printf("Thread %x is running \n",pthread_self());
  executiontime.tv_sec=0;
  executiontime.tv_nsec=us_to_ns(100);
  status=clock_gettime(CLOCK_REALTIME, &starttime);
  if(status<0)
  ...
  do 
  {
    Va_f=Va_filter_100(aircraft_dynamics495_Va_Va_filter_100449_Va[Va_rcell]);
      ...
      status=clock_gettime(CLOCK_REALTIME, &currentime);
      if(status<0)
		  returncode("clock_gettime ",status);
	  
         
  }while (ts_compare (currentime, ts_add(starttime,executiontime))!=1) ;
  	  instance++;
 #endif
#endif  
...
int elevator489_fun(void* args)
{
 ...
 #ifdef CONFIGURE_MONANO_CHANGE_PRIORITY  
...
int Va_c0_fun(void* args)
{
  ...
  printf("Thread %x is running \n",pthread_self());  
  executiontime.tv_sec=0;
  executiontime.tv_nsec=us_to_ns(500);
  status=clock_gettime(CLOCK_REALTIME, &starttime);
  if(status<0)
    returncode("clock_gettime ",status);  
  do 
...
int altitude_hold_50464_fun(void* args)
{
  ...
  do 
  {   
      Vz_c=altitude_hold_50(h_filter_100446_h_f_altitude_hold_50464_h_f[h_f_rcell],h_c_altitude_hold_50464_h_c);
...
int az_filter_100458_fun(void* args)
{
  ...
  const struct write_proto_t az_f_Vz_control_50483_az_f_write =  { NULL, 0, (int []){ true , false }, 2 };
...
int Vz_filter_100452_fun(void* args)
{
  ...
  const struct write_proto_t Vz_f_Va_control_50474_Vz_f_write = { NULL, 0, (int []){ true , false }, 2 };
  static int Vz_f_Va_control_50474_Vz_f_wcell=0;
  const struct write_proto_t Vz_f_Vz_control_50483_Vz_f_write =  { NULL, 0, (int []){ true , false }, 2 };
...
int q_filter_100455_fun(void* args)
{
  ...
  const struct write_proto_t q_f_Va_control_50474_q_f_write =   { NULL, 0, (int []){ true , false }, 2 };
  static int q_f_Va_control_50474_q_f_wcell=0;
  const struct write_proto_t q_f_Vz_control_50483_q_f_write =   { NULL, 0, (int []){ true , false }, 2 };
...
int aircraft_dynamics495_fun(void* args)
{
  ...
  const struct write_proto_t Va_Va_filter_100449_Va_write = { NULL, 0, (int []){ true , false }, 2 };
  static int Va_Va_filter_100449_Va_wcell=0;
  const struct write_proto_t Vz_Vz_filter_100452_Vz_write = { NULL, 0, (int []){ true , false }, 2 };
  static int Vz_Vz_filter_100452_Vz_wcell=0;
  const struct write_proto_t q_q_filter_100455_q_write = { NULL, 0, (int []){ true , false }, 2 };
  static int q_q_filter_100455_q_wcell=0;
  const struct write_proto_t az_az_filter_100458_az_write =  { NULL, 0, (int []){ true , false }, 2 };
  static int az_az_filter_100458_az_wcell=0;
  const struct write_proto_t h_h_filter_100446_h_write =  { NULL, 0, (int []){ true , false }, 2 };
  ...
  printf("Thread %x is running \n",pthread_self());
  executiontime.tv_sec=0;
  executiontime.tv_nsec=us_to_ns(200);  
  status=clock_gettime(CLOCK_REALTIME, &starttime);
  if(status<0)
    returncode("clock_gettime ",status); 
  do 
...
int h_filter_100446_fun(void* args)
{
  ...
  const struct write_proto_t h_f_altitude_hold_50464_h_f_write =  { NULL, 0, (int []){ true , false }, 2 };
...
static struct job_prec Va_filter_100449_Va_control_50474_pcpat[1] = { {0,0} };
...
static struct job_prec aircraft_dynamics495_q_filter_100455_pcpat[1] = {{0,0} };
...
static struct job_prec Vz_filter_100452_Va_control_50474_pcpat[1] = { {0,0} };
static struct job_prec Vz_filter_100452_Vz_control_50483_pcpat[1] = { {0,0} };
static struct job_prec h_filter_100446_altitude_hold_50464_pcpat[1] = { {0,0} };
static struct job_prec aircraft_dynamics495_az_filter_100458_pcpat[1] = {{0,0} };
static struct job_prec elevator489_aircraft_dynamics495_pcpat[1] = { {0,1} };
static struct job_prec aircraft_dynamics495_Vz_filter_100452_pcpat[1] = {{0,0} };
static struct job_prec az_filter_100458_Vz_control_50483_pcpat[1] = { {0,0} };
static struct job_prec h_c0_altitude_hold_50464_pcpat[1] = { {0,0} };
static struct job_prec altitude_hold_50464_Vz_control_50483_pcpat[1] = {{0,0} };
static struct job_prec aircraft_dynamics495_Va_filter_100449_pcpat[1] = {{0,0} };
static struct job_prec aircraft_dynamics495_h_filter_100446_pcpat[1] = {{0,0} };
...
static struct multirate_precedence static_prec_set[PLUD_PREC_NUMBER] = {
  { "engine486", "aircraft_dynamics495", 0, 1, NULL,  engine486_aircraft_dynamics495_pcpat },
  { "Va_filter_100449", "Va_control_50474", 0, 1, NULL,  Va_filter_100449_Va_control_50474_pcpat },
  { "q_filter_100455", "Va_control_50474", 0, 1, NULL,  q_filter_100455_Va_control_50474_pcpat },
  { "q_filter_100455", "Vz_control_50483", 0, 1, NULL,  q_filter_100455_Vz_control_50483_pcpat },
  { "aircraft_dynamics495", "q_filter_100455", 0, 1, NULL,  aircraft_dynamics495_q_filter_100455_pcpat },
  { "Va_c0", "Va_control_50474", 0, 1, NULL, Va_c0_Va_control_50474_pcpat },
  { "Vz_control_50483", "delta_e_c0", 0, 1, NULL,  Vz_control_50483_delta_e_c0_pcpat },
  { "Vz_control_50483", "elevator489", 0, 1, NULL,  Vz_control_50483_elevator489_pcpat },
  { "Vz_filter_100452", "Va_control_50474", 0, 1, NULL,  Vz_filter_100452_Va_control_50474_pcpat },
  { "Vz_filter_100452", "Vz_control_50483", 0, 1, NULL,  Vz_filter_100452_Vz_control_50483_pcpat },
  { "h_filter_100446", "altitude_hold_50464", 0, 1, NULL,  h_filter_100446_altitude_hold_50464_pcpat },
  { "aircraft_dynamics495", "az_filter_100458", 0, 1, NULL,  aircraft_dynamics495_az_filter_100458_pcpat },
  { "elevator489", "aircraft_dynamics495", 0, 1, NULL,  elevator489_aircraft_dynamics495_pcpat },
  { "aircraft_dynamics495", "Vz_filter_100452", 0, 1, NULL,  aircraft_dynamics495_Vz_filter_100452_pcpat },
  { "az_filter_100458", "Vz_control_50483", 0, 1, NULL,  az_filter_100458_Vz_control_50483_pcpat },
  { "h_c0", "altitude_hold_50464", 0, 1, NULL, h_c0_altitude_hold_50464_pcpat  },
  { "altitude_hold_50464", "Vz_control_50483", 0, 1, NULL,  altitude_hold_50464_Vz_control_50483_pcpat },
  { "aircraft_dynamics495", "Va_filter_100449", 0, 1, NULL,  aircraft_dynamics495_Va_filter_100449_pcpat },
  { "aircraft_dynamics495", "h_filter_100446", 0, 1, NULL,  aircraft_dynamics495_h_filter_100446_pcpat },
  { "Va_control_50474", "engine486", 0, 1, NULL,  Va_control_50474_engine486_pcpat },
  { "Va_control_50474", "delta_th_c0", 0, 1, NULL,  Va_control_50474_delta_th_c0_pcpat }
};
