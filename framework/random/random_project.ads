...
package random_project is

   -- generate system 1 consumer/Nb_Prod producer
   --
   ...
   -- equal function for numeric stability
   --
   ...
   -- generate system Nb_Cons consumer/Nb_Prod producer
   --
