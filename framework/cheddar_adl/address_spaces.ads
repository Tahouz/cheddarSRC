...
Package Address_Spaces is 
 
type Address_Space; type Address_Space_Ptr is access all Address_Space'Class;



-- --------= Address_Space =--------

type Address_Space is new Named_Object with 
record
 cpu_name : Unbounded_String;
 text_memory_size : Natural;
 stack_memory_size : Natural;
 data_memory_size : Natural;
 heap_memory_size : Natural;
...
procedure Initialize(obj : in out Address_Space);
procedure Put(obj : in Address_Space);
procedure Put(obj : in Address_Space_Ptr);
procedure Put_Name(obj : in Address_Space_Ptr);
procedure Build_Attributes_XML_String(obj : in Address_Space; result : in out Unbounded_String);
function XML_String(obj : in Address_Space) return Unbounded_String;
function XML_String(obj : in Address_Space_Ptr) return Unbounded_String;
function XML_Ref_String(obj : in Address_Space) return Unbounded_String;
function XML_Ref_String(obj : in Address_Space_Ptr) return Unbounded_String;
function Get_Name (obj : in Address_Space) return Unbounded_String;
function Get_Name (obj : in Address_Space_Ptr) return Unbounded_String;
function Copy(obj : in Address_Space_Ptr) return Address_Space_Ptr;
