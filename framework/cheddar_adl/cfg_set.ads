...
package cfg_set is
   ...
   ----------------------------------------------------------
   package cfg_set is new sets
     (max_element    => Framework_Config.Max_CFGs,
      element        => cfg_ptr,
      free           => Free,
      copy           => Copy,
      put            => Put,
   ...
   type cfgs_set is new cfg_set.set with private;

   subtype cfgs_range is cfg_set.element_range;
   subtype cfgs_iterator is cfg_set.iterator;
   ...
   -- ADD
   ----------------------------------------------------
   procedure add_cfg (my_cfgs : in out cfgs_set; a_cfg : in out cfg_ptr);
   -- Add a CFG node pointer to a set
...
private
   type cfgs_set is new cfg_set.set with null record;
