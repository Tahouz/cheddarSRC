...
package body applicability_constraint.no_shared_resources is

   function r5 (sys : system) return Boolean is
      context : system;
   ...
   function r5_txt return Unbounded_String is
   begin

      return ("The constraint R5 is not met:") &
        unbounded_lf &
...
end applicability_constraint.no_shared_resources;
