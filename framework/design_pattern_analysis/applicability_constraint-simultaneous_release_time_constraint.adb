...
package body applicability_constraint.simultaneous_release_time_constraint is
   ...
   begin
      ...
      return (t2.start_time = t3.start_time);
...
end applicability_constraint.simultaneous_release_time_constraint;
