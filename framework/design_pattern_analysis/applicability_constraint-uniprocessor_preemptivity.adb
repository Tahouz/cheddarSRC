...
package body applicability_constraint.uniprocessor_preemptivity is

   function r3 (sys : system) return Boolean is
   ...
   begin
      ...
      return (p2.core.scheduling.preemptive_type = preemptive) or
        (p2.core.scheduling.preemptive_type = not_preemptive);

   end r3;

   function r3_txt return Unbounded_String is
   begin

      return ("The environmental constraint R3 is not met:") &
        unbounded_lf &
        ("the scheduling policy must be preemptive or not preemptive.") &
        unbounded_lf;

   end r3_txt;

end applicability_constraint.uniprocessor_preemptivity;
