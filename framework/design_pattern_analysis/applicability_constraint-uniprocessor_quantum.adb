...
package body applicability_constraint.uniprocessor_quantum is

   function r4 (sys : system) return Boolean is
   ...
   begin
      ...
      return p2.core.scheduling.quantum = 0;

   end r4;

   function r4_txt return Unbounded_String is
   begin

      return ("The environmental constraint R4 is not met:") &
        unbounded_lf &
        ("the quantum must be equal to 0.") &
        unbounded_lf;

   end r4_txt;

end applicability_constraint.uniprocessor_quantum;
