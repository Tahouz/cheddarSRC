...
package body applicability_constraint.no_dependencies is

   function r15 (sys : system) return Boolean is
      context : system;

   begin
      context := sys;
      return
        (get_number_of_elements (sys.dependencies.depends) =
         tasks_dependencies_range (0)) and
        (get_number_of_elements (sys.buffers) = buffers_range (0));

   end r15;

   function r15_txt return Unbounded_String is
   begin

      return ("The constraint R15 is not met:") &
        unbounded_lf &
