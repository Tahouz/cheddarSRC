...
package body applicability_constraint.period_larger_than_deadline_constraint is
   ...
   begin
      ...
      return (t2.task_type = periodic_type) and (ptr.period > (ptr.deadline));
...
end applicability_constraint.period_larger_than_deadline_constraint;
