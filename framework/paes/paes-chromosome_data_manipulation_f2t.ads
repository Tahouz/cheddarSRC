...
--
package paes.chromosome_data_manipulation_f2t is
   ...
   one_to_one_mapping_solution : solution_f2t;
   ...
   procedure mutate_f2t (s : in out solution_f2t; eidx : in Natural);
   ...
   --
   function number_of_tasks (s : in solution_f2t) return Integer;
   ...
   --
   procedure create_system (a_system : in out systems.system);
