...
with paes.chromosome_data_manipulation_f2t; use paes.chromosome_data_manipulation_f2t;
...
package paes.objective_functions.function2task is
   ...
   --
   procedure evaluate_f2t (s : in out solution_f2t; eidx : in Natural);

end paes.objective_functions.function2task;
