...
--
package Objective_Functions_and_Feasibility_Checks_mils is
   ...
   --
   function Check_Feasibility_of_A_Solution (s : in out solution; eidx : in Natural) return boolean;
   ...
   --
   procedure evaluate_T2P (s : in out solution; eidx : in Natural);
