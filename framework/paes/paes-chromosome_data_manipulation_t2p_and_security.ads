...
--
package Paes.chromosome_Data_Manipulation_t2p_and_security is
   ...
   One_to_one_mapping_solution : solution_t2p;
   ...
   --
   procedure init_T2P;
   procedure mutate_T2P (s : in out generic_solution'class; eidx : in Natural);
   ...
   --
   procedure normalize (s : in out solution_t2p);
   ...
   -- candidate solution "s"
   function Number_of_partitions (s : in solution_t2p) return Integer;
   ...
   procedure com_overhead (A_sys : in out systems.system);
   --communication cost
