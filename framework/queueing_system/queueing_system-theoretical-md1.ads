...
package queueing_system.theoretical.md1 is

   type md1_queueing_system_theoretical is new generic_queueing_system_theoretical with
   null record;
   type md1_queueing_system_theoretical_ptr is
