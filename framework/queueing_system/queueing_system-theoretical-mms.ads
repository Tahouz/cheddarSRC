...
package queueing_system.theoretical.mms is

   type mms_queueing_system_theoretical is new generic_queueing_system_theoretical with
   record
      nb_tasks : Double;
   end record;
   type mms_queueing_system_theoretical_ptr is
   ...
   -- return the number of tasks for mms queueing system
   --
   function get_qs_nb_tasks
     (a_queueing_system : in mms_queueing_system_theoretical) return Double;

   -- set the number of tasks for mms queueing system
   --
