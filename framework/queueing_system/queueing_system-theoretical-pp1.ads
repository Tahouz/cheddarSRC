...
package queueing_system.theoretical.pp1 is
   ...
   type pp1_queueing_system_theoretical is new generic_queueing_system_theoretical with
   null record;
   type pp1_queueing_system_theoretical_ptr is
   ...
   -- return the theorec probability to have N customers in the qs
   --
