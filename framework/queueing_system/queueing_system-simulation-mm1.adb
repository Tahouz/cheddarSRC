...
package body queueing_system.simulation.mm1 is
   ...
   begin
      ...
      a_queueing_system.queueing_system_type := qs_mm1;
   end initialize;
   ...
   is
      ...
      result : Double := 0.0;
   begin
      result := get_exponential_time (mst, seed);
      return result;
   ...
   begin
      result := get_exponential_time (mta, seed);
      return result;
