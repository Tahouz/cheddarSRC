...
procedure To_Queueing_Systems_Type is
new Convert_Strings(Queueing_Systems_Type, Qs_Mm1);
procedure To_Queueing_Systems_Type is
new Convert_Unbounded_Strings(Queueing_Systems_Type, Qs_Mm1);
function XML_String (obj : in Queueing_Systems_Type) return Unbounded_String;
function XML_Ref_String (obj : in Queueing_Systems_Type) return Unbounded_String;
package Queueing_Systems_Type_io is new text_io.enumeration_io(Queueing_Systems_Type);
use Queueing_Systems_Type_io;
